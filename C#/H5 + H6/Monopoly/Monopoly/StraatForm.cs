...
namespace Monopoly
{
    public partial class StraatForm : Form
    {
        ...
        public StraatForm(String StraatNaam,String Stad,int onbebouwd, int eenHuis, int tweeHuizen, int drieHhuizen, int vierHuizen ,int hotel,Color kleur)
        {
            InitializeComponent();

            _straat = new MonopolyStraat(StraatNaam, Stad, onbebouwd, eenHuis, tweeHuizen, drieHhuizen, vierHuizen, hotel);
